                  ...
                  >
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      {showShareMenu[2] && (
                        ...
                        >
                          <button
                            onClick={() => handleShare(2, "linkedin")}
                            style={{
                              width: "100%",
                              textAlign: "left",
                              padding: "8px 12px",
                          ...
                          <button
                            onClick={() => handleShare(2, "facebook")}
                            style={{
                              width: "100%",
                              textAlign: "left",
                              padding: "8px 12px",
                  ...
                  >
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      {showShareMenu[3] && (
                        ...
                        >
                          <button
                            onClick={() => handleShare(3, "linkedin")}
                            style={{
                              width: "100%",
                              textAlign: "left",
                              padding: "8px 12px",
                          ...
                          <button
                            onClick={() => handleShare(3, "facebook")}
                            style={{
                              width: "100%",
                              textAlign: "left",
                              padding: "8px 12px",
