  ...
  const tasks: Task[] = [
    {
      ...
      description: "Complete self-evaluation",
      dueDate: "Dec 16, 2024",
      category: "HR",
      priority: "High",
      status: "In Progress",
    ...
    },
    {
      ...
      description: "Revise project docs",
      dueDate: "Dec 20, 2024",
      ...
      progress: 0,
      notes: "HR approval needed",
    },
    {
      id: 3,
      title: "Team Presentation",
      description: "Prepare monthly slides",
      dueDate: "Dec 18, 2024",
      category: "Meetings",
      priority: "Medium",
      status: "Review",
    ...
    },
    {
      id: 5,
      title: "Code Review",
      description: "Review sprint commits",
      dueDate: "Dec 15, 2024",
    ...
    },
    {
      ...
      description: "Prepare proposal deck",
      dueDate: "Dec 17, 2024",
      category: "Sales",
      priority: "High",
      status: "Review",
    ...
    "John Doe": [
      {
        ...
        description: "Complete performance review documentation",
        dueDate: "2024-12-16",
    ...
    "Alex Kim": [
      {
        ...
        startDate: "Dec 8, 2024",
        progress: 45,
        notes: "3 of 7 reviews completed",
      },
    ],
    "Sarah Johnson": [
      {
      ...
      <div className="mb-1.5 sm:mb-2 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
        ...
        <div className="flex gap-1 sm:gap-2 flex-wrap">
          <button
            ...
            className="px-3 py-1.5 text-xs text-gray-700 font-medium hover:bg-gray-200 rounded-lg transition-colors flex items-center gap-1.5"
          >
            <Zap className="w-3.5 h-3.5" />
            AI Assistant
          </button>
          <button
            onClick={() => setActiveModal("newTask")}
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {filteredTasks.map((task) => (
                      ...
                      >
                        <td
                          className="px-3 py-2.5 text-xs font-semibold text-gray-900 max-w-[150px] truncate"
                          title={task.title}
                        >
                          {task.title}
                        </td>
                        ...
                        <td className="px-3 py-2.5 text-center">
                          <div className="relative inline-block">
                            <button
                              onClick={() =>
                                setActionDropdown(
                                  actionDropdown === task.id ? null : task.id,
                                )
                              }
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-2">
                  {["All Status", "Todo", "In Progress", "Review", "Done"].map(
                    (status) => (
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Ask AI to help with your tasks. You can request task
                suggestions, summaries, or automation.
              </p>
              <textarea
                value={aiInput}
              ...
              <div className="bg-blue-50 border border-blue-200 p-3 rounded-lg text-sm text-blue-800">
                <p>
                  AI can help you: Create tasks, Summarize progress, Set
                  reminders, Assign tasks
                </p>
              </div>
              <div className="flex gap-3">
                <button
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-xs text-gray-600 mt-2">
                  {selectedProject.completedTasks} of{" "}
              ...
              <div className="bg-blue-50 border border-blue-200 p-3 rounded-lg text-sm text-blue-800">
                <p>
                  Project is in progress. Continue tracking tasks in the My
                  Tasks tab.
                </p>
              </div>
