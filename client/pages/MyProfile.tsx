...
export default function MyProfile() {
  ...
  const [openCertificationMenu, setOpenCertificationMenu] = useState<
    number | null
  >(null);
  ...
  const [showPayslipCheckboxes, setShowPayslipCheckboxes] =
    useState<boolean>(false);
  ...
  const confirmDeleteLeave = () => {
    if (selectedLeave) {
      setNotification({
        message: `Leave request for ${selectedLeave.leaveType} has been deleted`,
        type: "success",
      });
  ...
  const handleDownloadPayslips = () => {
    ...
    const selectedPayslipData = payslips.filter((p) =>
      selectedPayslips.includes(p.id),
    );
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        ...
        openSkillMenu !== null ||
        openDocMenu !== null ||
        openTrainingMenu !== null ||
        openCertificationMenu !== null
      ) {
  ...
  const certifications: Training[] = [
    ...
    },
    {
      ...
      issuer: "ISACA",
      issueDate: "02/25/2021",
      expiryDate: "02/25/2024",
      status: "Expired",
    },
  ];
  ...
  const handleEditSubmit = (type: EditModalType) => {
    showNotification(
      `${type === "personal" ? "Personal" : type === "contact" ? "Contact" : "Training"} information updated successfully`,
      "success",
    );
  ...
  return (
    <Layout>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span
                          className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-green-100 text-green-700 text-xs font-medium whitespace-nowrap"
                          style={{ fontFamily: "Poppins, sans-serif" }}
                        >
              ...
              >
                ...
                >
                  <thead>
                    ...
                    >
                      <th className="px-4 py-2 text-left text-xs text-gray-900">
                        Training Name
                      </th>
                      <th className="px-4 py-2 text-left text-xs text-gray-900">
                    ...
                    {trainings.map((training) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-2 text-xs">
                          <span
                            className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-medium ${training.status === "Active" ? "bg-green-100 text-green-700" : "bg-blue-100 text-blue-700"}`}
                          >
                            {training.status}
                          </span>
                        </td>
              ...
              >
                <div className="flex items-start gap-2 mb-3">
                  ...
                  <div>
                    ...
                    >
                      View your current salary details and compensation.
                    </p>
                  </div>
                </div>
                ...
                >
                  <thead>
                    ...
                    >
                      {showPayslipCheckboxes && (
                        <th
                          className="px-4 py-3 text-center font-semibold text-xs text-gray-900"
                          style={{ width: "40px" }}
                        >
                          <input
                            type="checkbox"
                      ...
                      <th className="px-4 py-3 text-center font-semibold text-xs text-gray-900">
                        Action
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {payslips.map((payslip) => (
                      ...
                      >
                        {showPayslipCheckboxes && (
                          <td className="px-4 py-3 text-center">
                            <input
                              ...
                              onChange={() =>
                                togglePayslipSelection(payslip.id)
                              }
                              className="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 cursor-pointer"
                            />
                          </td>
                        ...
                        <td className="px-4 py-3 text-center">
                          <button
                            className="text-blue-600 hover:text-blue-800 transition-colors text-xs flex items-center gap-1 justify-center mx-auto"
                            title="Download"
                          >
                            <Download className="w-3.5 h-3.5" />
                          </button>
              ...
              >
                <div className="flex items-start gap-2 mb-3">
                  ...
                  <div>
                    ...
                    >
                      Your current performance metrics and ratings.
                    </p>
                  </div>
                </div>
                      ...
                      >
                        ...
                        <td className="px-3 py-2 text-center relative">
                          <button
                            onClick={() =>
                              setOpenSkillMenu(
                                openSkillMenu === skill.id ? null : skill.id,
                              )
                            }
                            className="text-gray-600 hover:text-gray-900 transition-colors"
                            title="Actions"
                ...
                >
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm">
                        <span
                          className="inline-block rounded-lg px-3 py-1 font-semibold text-xs"
                          style={{
                      ...
                      <td className="px-4 py-3 text-sm relative">
                        <button
                          onClick={() =>
                            setOpenLeaveMenu(openLeaveMenu === 1 ? null : 1)
                          }
                          className="text-gray-600 hover:text-gray-900 transition-colors"
                          title="Actions"
                        >
                        ...
                        {openLeaveMenu === 1 && (
                          ...
                          >
                            <button
                              onClick={() =>
                                handleViewLeaveDetails(leaveHistory[0])
                              }
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                            >
                              <Eye className="w-4 h-4" />
                            ...
                            <button
                              onClick={() => handleDeleteLeave(leaveHistory[0])}
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors"
                            >
                              <Trash2 className="w-4 h-4" />
                              Delete
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm relative">
                        <button
                          onClick={() =>
                            setOpenLeaveMenu(openLeaveMenu === 2 ? null : 2)
                          }
                          className="text-gray-600 hover:text-gray-900 transition-colors"
                          title="Actions"
                        >
                        ...
                        {openLeaveMenu === 2 && (
                          ...
                          >
                            <button
                              onClick={() =>
                                handleViewLeaveDetails(leaveHistory[1])
                              }
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                            >
                              <Eye className="w-4 h-4" />
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm relative">
                        <button
                          onClick={() =>
                            setOpenLeaveMenu(openLeaveMenu === 3 ? null : 3)
                          }
                          className="text-gray-600 hover:text-gray-900 transition-colors"
                          title="Actions"
                        >
                        ...
                        {openLeaveMenu === 3 && (
                          ...
                          >
                            <button
                              onClick={() =>
                                handleViewLeaveDetails(leaveHistory[2])
                              }
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                            >
                              <Eye className="w-4 h-4" />
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm relative">
                        <button
                          onClick={() =>
                            setOpenLeaveMenu(openLeaveMenu === 4 ? null : 4)
                          }
                          className="text-gray-600 hover:text-gray-900 transition-colors"
                          title="Actions"
                        >
                        ...
                        {openLeaveMenu === 4 && (
                          ...
                          >
                            <button
                              onClick={() =>
                                handleViewLeaveDetails(leaveHistory[3])
                              }
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                            >
                              <Eye className="w-4 h-4" />
                            ...
                            <button
                              onClick={() => handleDeleteLeave(leaveHistory[3])}
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors"
                            >
                              <Trash2 className="w-4 h-4" />
                              Delete
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setLeaveForm({ ...leaveForm, approver: e.target.value })
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                      style={{
                        fontFamily: "Poppins, sans-serif",
                    ...
                    >
                      ...
                      <option value="Michael Rodriguez">
                        Michael Rodriguez - Manager
                      </option>
                      <option value="Jennifer Smith">
                        Jennifer Smith - HR Director
                      </option>
                      <option value="David Chen">
                        David Chen - Department Head
                      </option>
                      <option value="Emily Brown">
                        Emily Brown - VP Operations
                      </option>
                    </select>
                  </div>
                ...
                >
                  <thead>
                    ...
                    >
                      {showDocCheckboxes && (
                        <th
                          className="px-3 py-2 text-center font-semibold text-xs text-gray-700"
                          style={{ width: "40px" }}
                        >
                          <input
                            type="checkbox"
                      ...
                      <th className="px-3 py-2 text-center font-semibold text-xs text-gray-700">
                        Action
                      </th>
                    </tr>
                  </thead>
                      ...
                      >
                        ...
                        <td className="px-3 py-2.5 text-center relative">
                          <button
                            onClick={() =>
                              setOpenDocMenu(
                                openDocMenu === doc.id ? null : doc.id,
                              )
                            }
                            className="text-gray-600 hover:text-gray-900 transition-colors"
                            title="Actions"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                onClick={() => handleEditSubmit("personal")}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setContactForm({ ...contactForm, street: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={contactForm.emergencyAlternatePhone}
                      onChange={(e) =>
                        setContactForm({
                          ...contactForm,
                          emergencyAlternatePhone: e.target.value,
                        })
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                onClick={() => handleEditSubmit("contact")}
                className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors text-sm"
              >
                Save Changes
              </button>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTrainingForm({ ...trainingForm, issuer: e.target.value })
                  }
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  onClick={() => handleEditSubmit("training")}
                  className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors text-sm"
                >
                  Add
                </button>
      ...
      {showDeleteConfirmModal && selectedLeave && (
        ...
        >
          ...
          >
            ...
            >
              Are you sure you want to delete this {selectedLeave.leaveType}{" "}
              request for {selectedLeave.duration}? This action cannot be
              undone.
            </p>
      ...
      {/* Edit Position History Modal */}
      {editModalType === "positionHistory" && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div
            style={{
              backgroundColor: "#FFFFFF",
            ...
            >
              ...
              <button
                onClick={() => {
                  setEditModalType(null);
                  setNotification({
                    message: "Position History updated successfully",
                    type: "success",
                  });
                  setTimeout(() => setNotification(null), 3000);
                }}
      ...
      {/* Edit Previous Work History Modal */}
      {editModalType === "workHistory" && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div
            style={{
              backgroundColor: "#FFFFFF",
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div>
                ...
                <textarea
                  defaultValue="Career advancement"
                  rows={3}
                  style={{
                    width: "100%",
                    padding: "10px 12px",
