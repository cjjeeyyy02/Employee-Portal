...
export default function MyProfile() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (openLeaveMenu !== null || openSkillMenu !== null || openDocMenu !== null || openTrainingMenu !== null || openCertificationMenu !== null) {
  ...
  }, [openLeaveMenu, openSkillMenu, openDocMenu, openTrainingMenu, openCertificationMenu]);
            ...
            <div className="space-y-3">
              ...
              <div style={{
                ...
                <div className="flex items-center justify-between gap-2 mb-3">
                  ...
                  <button
                    onClick={() => {
                      setNotification({ message: 'Edit Previous Work History functionality', type: 'info' });
                      setTimeout(() => setNotification(null), 3000);
                    }}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-300 text-gray-700 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 transition-all text-xs font-medium"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                    ...
                    {trainings.map((training) => (
                      <tr key={training.id} style={{ borderBottom: "1px solid #E5E7EB" }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#F9FAFB")} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#FFFFFF")}>
                        ...
                        <td className="px-4 py-2 text-xs relative">
                          <button
                            onClick={() => setOpenTrainingMenu(openTrainingMenu === training.id ? null : training.id)}
                    ...
                    <tr style={{ borderBottom: "1px solid #E5E7EB" }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#F9FAFB")} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#FFFFFF")}>
                      ...
                      <td className="px-4 py-3 text-sm relative">
                        ...
                        {openLeaveMenu === 1 && (
                          ...
                          >
                            <button
                              onClick={() => handleViewLeaveDetails(leaveHistory[0])}
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                            >
                              <Eye className="w-4 h-4" />
                              View Details
                    ...
                    <tr onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#F9FAFB")} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#FFFFFF")}>
                      ...
                      <td className="px-4 py-3 text-sm relative">
                        ...
                        {openLeaveMenu === 4 && (
                          ...
                          >
                            <button
                              onClick={() => handleViewLeaveDetails(leaveHistory[3])}
                              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                            >
                              <Eye className="w-4 h-4" />
                              View Details
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setContactForm({...contactForm, emergencyRelationship: e.target.value})}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setContactForm({...contactForm, emergencyAlternatePhone: e.target.value})}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                </div>
