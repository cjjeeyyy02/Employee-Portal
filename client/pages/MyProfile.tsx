          ...
          <div style={{ paddingTop: "24px", paddingBottom: "24px", paddingLeft: "32px", paddingRight: "32px", backgroundColor: "#FFFFFF" }}>
            <div className="space-y-8">
              ...
              <div style={{
                ...
                <h2 className="text-base font-bold text-gray-900 mb-6" style={{ fontFamily: "Poppins, sans-serif", fontSize: "15px", fontWeight: 600 }}>Today's Attendance</h2>

                <div className="flex flex-col gap-4 mb-6">
                  <div>
                    <p className="text-xs text-gray-600 mb-2" style={{ fontFamily: "Poppins, sans-serif" }}>Current Date & Time</p>
                    <p className="text-sm font-bold text-gray-900" style={{ fontFamily: "Poppins, sans-serif", fontSize: "14px" }}>Oct 18, 2024</p>
                  </div>
