          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route
                ...
                element={<Placeholder title="Leave & Attendance" />}
              />
              <Route
                path="/payroll-benefits"
                element={<Placeholder title="Payroll & Benefits" />}
              />
              <Route
                path="/tasks"
                element={<Placeholder title="Task Management" />}
              />
              <Route
                path="/performance"
                element={<Placeholder title="Performance" />}
              />
              <Route
                path="/requests"
                element={<Placeholder title="Requests & Documents" />}
              />
              <Route
                path="/communications"
                element={<Placeholder title="Communications" />}
              />
              <Route path="/team-management" element={<TeamManagement />} />
              <Route path="/team-attendance" element={<TeamAttendance />} />
              <Route
                path="/team-task-management"
              ...
              <Route
                path="/my-leave-attendance"
                element={<MyLeaveAttendance />}
              />
              <Route path="/my-performance" element={<MyPerformance />} />
              <Route path="/my-tasks" element={<MyTasks />} />
              <Route
                path="/my-payslips"
                element={<Placeholder title="My Payslips" />}
              />
